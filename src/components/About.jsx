    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
      ...
      <div data-aos="fade-right">
        ...
        <div className="space-y-4 text-lg text-gray-100">
          <p>
            Ruchi Mishra is a certified bridal and beauty expert in Agra.
            Learn more about her journey, experience, and her passion for
            redefining beauty in Agra.
          </p>

          <p>
            Hi, I’m Ruchi Mishra, a certified makeup and beauty professional
            based in Agra with years of experience in bridal makeovers and
            salon services. From elegant brides to everyday clients, I’ve
            helped hundreds of women across Agra look flawless for their
            special moments.
          </p>

          <h5 className="text-yellow-300 font-semibold text-lg">
            ✨ Why Choose Us:
          </h5>
        ...
        <div className="mt-8">
          <button className="bg-white text-orange-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition shadow-lg">
            Learn More About Us
          </button>
        </div>
      </div>
